...
function Empviewattendancedetail() {

    let Sn = 1;
    let location = useLocation();
    let [data, setData] = useState([]);
    let tdata = location.state;
    const empid = tdata.id;
    const date1 = tdata.date;
    console.log(tdata.date);
    async function empData() {
        let apiURL = `http://localhost:4000/empviewattendancedetail?d=${date1}&id=${empid}`;
...
export default Empviewattendancedetail 